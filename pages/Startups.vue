<template>
  <main class="main">
    ...
    <section class="main__section cards-section">
      ...
      <div class="fluid-section__container">
        <div class="fluid-section__info">
          ...
          <div class="fluid-section__btn-group">
            ...
            <button class="fluid-section__btn fluid-section__btn--md button">
              Стать инвестором
            </button>
          </div>
        </div>
    ...
    <section class="main__section cards-section">
      <div class="cards-section__container">
        <div class="cards-section__top-of-day">
          <div class="cards-section__row">
            <h4 class="cards-section__title">Стартап дня</h4>
          </div>
          <div class="cards-section__card card">
...
export default {
  ...
  mounted() {
    ...
    var swiper2 = new Swiper('.courses-section__swiper-container', {
      slidesPerView: 4,
      spaceBetween: 45,
      pagination: {
